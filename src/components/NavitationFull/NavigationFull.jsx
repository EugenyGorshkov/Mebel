        ...
        >
            ...
            <div className={cn('block lg:flex gap-16', styles.burger_body, activeBurger ? styles._active : '')}>
                <ul className='block lg:flex items-center gap-16'>
                    <li className={styleListItemTw}><Link to='/'>Главная</Link></li>
                    <ul><li></li></ul>
                    <li className={styleListItemTw}><Link to='/contacts'>Контакты</Link></li>
                </ul>

                <img className='hidden lg:block max-w-[80px]' src={logo} alt="#" />
 
                <ul className='block lg:flex items-center gap-16'>
                    <li className={styleListItemTw}><Link to='/about'>О Компании</Link></li>
                    <li className={styleListItemTw}><Link to='/12'>8-800-555-35-35</Link></li>
                    <li className={styleListItemTw}>Ru</li>
                </ul>
            </div>
